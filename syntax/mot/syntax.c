...
{
  add_atom(0,new_rorg_atom(parse_expr_tmplab(&s)));
}
...
struct {
  ...
  "load",handle_dummy_cexpr,
  "jumperr",handle_dummy_cexpr,
  "jumpptr",handle_dummy_cexpr,
  "mask2",eol,
  "cnop",handle_cnop,
  "align",handle_align,
  "even",handle_even,
