...
struct symbol {
  ...
  taddr pc;
  taddr align;
  size_t idx; /* usable by output module */
};
...
extern int final_pass,produce_listing,listformfeed,listlinesperpage,listnosyms;
